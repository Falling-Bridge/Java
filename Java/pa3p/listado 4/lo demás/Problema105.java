    ...
    public Bebida comprarBebida(Moneda m, int cual) {
        if (m != null) {
            if(m.getValor()<price || (cual != COCA && cual != SPRITE)){
                ...
                switch (cual) {
                    case COCA: return coca.getBebida();
                    case SPRITE: return sprite.getBebida();
                    default: return null;
                }
            }
        }
...
public class Problema105 {
    public static void main(String[] args) {
        Comprador cum = new Comprador(new Moneda100(), Expendedor.COCA, null);
        Moneda100 coin = new Moneda100();
